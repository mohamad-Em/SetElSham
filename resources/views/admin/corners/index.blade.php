        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="text-blue h4">All Corners</h4>
                    </div>
                    <div class="pull-right">
                        <a href="{{ route('admin.corners.create') }}" class="btn btn-primary">Create</a>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.corners.delete',$row->id) }}" class="btn btn-danger" onclick="return confirm('Are You Sure Delete Corners ?')">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
